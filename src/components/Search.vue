...
<div>
  <img src="../assets/logo1.png" height="52" width="132" class="logo">
...
<style scoped>
  *{margin: 0;padding: 0; list-style: none;}
  ...
  body{
  background:url('https://cn.bing.com//th?id=OHR.Krakatoa_EN-CN1177253936_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp') no-repeat 0 0;
  background-size: 100%;
}
</style>